...
AppWizard a créé cette DLL FFMPEG_TCL pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application FFMPEG_TCL.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé FFMPEG_TCL.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
